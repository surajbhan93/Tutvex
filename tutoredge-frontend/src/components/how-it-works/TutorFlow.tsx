...
const DASHBOARD_FEATURES = [
  { label: "Assignments & Classes", icon: ClipboardCheck },
  { label: "Payments & Earnings", icon: Wallet },
  { label: "Students You Teach", icon: Users },
  { label: "Online / Offline Teaching", icon: Video },
];
