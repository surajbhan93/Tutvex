...
export default function WhyTutvex() {
  return (
    ...
    >
      ...
      {/* CONTENT GRID */}
      <div className="max-w-6xl mx-auto grid gap-8 sm:gap-10 lg:grid-cols-2">
        {/* FOR PARENTS */}
        <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
          ...
          <ul className="space-y-4 sm:space-y-5 text-sm sm:text-base text-gray-700">
            ...
            <li className="flex gap-3">
              <BookOpen className="text-indigo-600 mt-1 shrink-0" />
              <span>
            ...
            <li className="flex gap-3">
              <Star className="text-yellow-500 mt-1 shrink-0" />
              <span>
            ...
            <li className="flex gap-3">
              <BarChart3 className="text-indigo-600 mt-1 shrink-0" />
              <span>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
          ...
          <ul className="space-y-4 sm:space-y-5 text-sm sm:text-base text-gray-700">
            <li className="flex gap-3">
              <Users className="text-indigo-600 mt-1 shrink-0" />
              <span>
            ...
            <li className="flex gap-3">
              <Wallet className="text-green-600 mt-1 shrink-0" />
              <span>
      ...
      {/* TRUST FOOTER */}
      <div className="max-w-4xl mx-auto mt-12 sm:mt-16 text-center text-sm sm:text-base text-gray-600">
