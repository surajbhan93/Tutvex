...
const PARENT_STEPS = [
  {
    ...
    desc: "Click on “Find a Tutor” and register on Tutvex by creating your parent account.",
    icon: UserPlus,
  },
  {
    step: "2",
    title: "Add Student Details",
    desc: "Enter student class, subject, board, medium, and learning preferences.",
    icon: ClipboardList,
  },
  {
    step: "3",
    title: "Get Matching Tutors",
    desc: "Based on your requirements, we show you the most suitable verified tutors.",
    icon: Search,
  },
  {
    step: "4",
    title: "Send Tutor Request",
    desc: "Review tutor profiles and send a request to the tutor you prefer.",
    icon: Users,
  },
  {
    step: "5",
    title: "Parent Verification",
    desc: "Our team verifies parent details to ensure a safe and trusted learning environment.",
    icon: ShieldCheck,
  },
  {
    step: "6",
    title: "Tutor Assigned to Home",
    desc: "A verified Tutvex tutor is sent to your home for teaching.",
    icon: Home,
  },
  {
    step: "7",
    title: "Tutor Replacement if Needed",
    desc: "If you are not satisfied, we provide another verified tutor at no extra hassle.",
    icon: RefreshCcw,
  },
  {
    step: "8",
    title: "Access Parent Dashboard",
    desc: "Manage students, track performance, attendance, payments, and more.",
...
const DASHBOARD_FEATURES = [
  { label: "Multiple Students", icon: Users },
  { label: "Monthly Performance Reports", icon: BarChart3 },
  { label: "Attendance Tracking", icon: CalendarCheck },
  { label: "Test Series & Assessments", icon: ClipboardList },
  { label: "Payments & Invoices", icon: Wallet },
  { label: "Tutor Communication", icon: Video },
];
...
export default function ParentFlow() {
  return (
    <section className="relative mt-16 sm:mt-24 space-y-16 sm:space-y-24">
      {/* BACKGROUND */}
      ...
      <motion.section
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="grid lg:grid-cols-2 gap-8 sm:gap-10 items-center px-4"
      >
      ...
      <motion.section
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="bg-indigo-600 text-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 mx-4"
      >
