      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
            With over {new Date().getFullYear() - city.establishedYear}+ years of operational leadership in {city.state}, Tutvex has set the golden standard for private home tuition, academic mentorship, and student safety across the Taj City.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 hover:border-cyan-500/40 transition-all space-y-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Every home tutor in {city.name} undergoes government ID checks (Aadhaar/PAN), university degree audits, police background screening, written subject testing, and real trial sessions before taking tuition assignments.
            </p>
          </div>
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 hover:border-cyan-500/40 transition-all space-y-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Unlike crowded coaching institutes in {city.name}, private home tuition allows tutors to target student weaknesses directly, clear doubts instantly, and customize mock tests aligned with CBSE, ICSE, and UP Board schedules.
            </p>
          </div>
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 hover:border-cyan-500/40 transition-all space-y-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Our roster in {city.name} includes M.Sc, B.Tech, M.Tech, and DEI/Agra University alumni specializing in Class 10/12 Board preparation, JEE Advanced numerical problem solving, and NEET medical biology mastery.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
                Founded with a mission to bridge the gap between classroom teaching and individual comprehension, Tutvex has empowered over <strong>44,200+ students across {city.name}</strong>. We recognize that every student learns at a different velocity. Classroom lectures often move too quickly for foundational topics in Class 9-10 Science or Class 11-12 Mathematics. By deploying top-vetted private home tutors across residential hubs like <em>Kamla Nagar, Dayalbagh, Sadar Bazaar, Civil Lines, Shahganj, and Sikandra</em>, we deliver structured, safe, and stress-free academic growth directly to your home.
              </p>
              <div className="flex flex-wrap items-center gap-6 pt-4 text-xs sm:text-sm text-slate-400">
                ...
                <div>
                  <span className="block font-bold text-white text-base">11,800+</span>
          ...
          <div className="pt-8 border-t border-slate-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
              {[
                ...
                <div key={`step-agra-${idx}`} className="bg-slate-950 border border-slate-800 rounded-xl p-3.5 text-center space-y-1 hover:border-cyan-500/40 transition-colors">
