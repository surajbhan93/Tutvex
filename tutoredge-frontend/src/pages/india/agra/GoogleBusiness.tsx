...
export const GoogleBusiness: React.FC = () => {
  const cidLinkPlaceholder = "https://maps.google.com/?cid=9876543210_tutvex_agra";
  const googleReviewLinkPlaceholder = "https://g.page/r/tutvex-agra/review";
  const mapEmbedPlaceholderUrl = `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113524.321876!2d78.00807!3d27.17667!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397477614497e69b%3A0x125d81b43d5e27a6!2sAgra%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin`;
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 space-y-6">
            ...
            <div className="pt-2 text-[11px] text-slate-400 flex items-center justify-between border-t border-slate-800/80">
              <span>Google CID: 9876543210_tutvex_agra</span>
