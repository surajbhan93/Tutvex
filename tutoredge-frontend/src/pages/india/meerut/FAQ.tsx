...
export const FAQ: React.FC = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: `Yes, Tutvex maintains an extensive network of experienced, background-verified female home tutors across all key localities in ${city.name} including Shastri Nagar, Saket, Pallavpuram, Modipuram, and Rajendra Nagar for all school grades, board exams, and foundational subjects.`,
    ...
    {
      question: `Does Tutvex provide home tutors for CBSE, ICSE, and UP Board exams?`,
    ...
    },
    {
      ...
      answer: `Yes, Tutvex offers specialized home tutors for JEE Main, JEE Advanced, and NEET medical entrance exam preparation in ${city.name}. Our competitive exam tutors include engineering graduates, doctors, and senior institute faculties focused on advanced problem-solving, speed, accuracy, and previous 15-year entrance question banks.`,
