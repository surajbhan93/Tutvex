...
export const Schema: React.FC = () => {
  ...
  const organizationSchema = {
    ...
    alternateName: ["Tutvex Home Tutors", "Tutvex India"],
    url: baseUrl,
    logo: {
      "@type": "ImageObject",
  ...
  const localBusinessSchema = {
    ...
    image: `https://res.cloudinary.com/dbezxtffm/image/upload/v1785499574/20260731_1735_image_mxfwaz.png`,
    url: pageUrl,
    telephone: city.contact.phone,
  ...
  const tutorServiceSchema = {
    ...
    areaServed: city.locations.map((loc) => ({
      ...
      name: `${loc.name}, ${city.name}, ${city.state}`,
    })),
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: `Yes, Tutvex maintains an extensive network of experienced female home tutors across all key localities in ${city.name} including Shastri Nagar, Saket, Rajendra Nagar, and Pallavpuram for all subjects from primary to senior secondary classes.`,
        },
      },
      {
        "@type": "Question",
    ...
    review: [
      {
        ...
        reviewBody: `Found an exceptional Class 10 Math & Physics home tutor in Shastri Nagar, ${city.name}. My son scored 96% in his CBSE board exams thanks to Tutvex's dedicated mentorship.`,
        reviewRating: {
          "@type": "Rating",
          ratingValue: "5",
          bestRating: "5",
      ...
      },
      {
        ...
        reviewBody: `We hired a female home tutor for my daughter in Saket, ${city.name} for Class 12 Chemistry and Biology. Very punctual, background verified, and extremely knowledgeable!`,
        reviewRating: {
          "@type": "Rating",
          ratingValue: "5",
          bestRating: "5",
  ...
  // 9. Speakable Schema (for Voice / AI Assistant Optimization)
  ...
  // Combine schemas into JSON-LD script array
  const allSchemas = [
    websiteSchema,
    organizationSchema,
    localBusinessSchema,
